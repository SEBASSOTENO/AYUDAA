						...
						<form method="POST" action="{{ route('producto.store') }}"  role="form">
							...
							<div class="row">
								<div class="col-xs-6 col-sm-6 col-md-6">
									...
									<p id="error1"></p>
										<input type="text" name="nombre_p" id="nombre_p" onblur="valipro()" pattern="[a-záéíóúñ A-ZÁÉÍÓÚÑ ]+" class="form-control input-sm" placeholder="Nombre">
									</div>
								</div>
								<div class="col-xs-6 col-sm-6 col-md-6">
									<div class="form-group">
									<p id="error2"></p>
										<input type="text" name="costo" id="costo" onblur="valico()" pattern="[0-9.$]+" class="form-control input-sm" placeholder="Costo">
									</div>
								</div>
							</div>
							...
							<div class="form-group">
								<p id="error3"></p>
                            <input type="text" name="descripcion" id="descripcion" onblur="valide()" pattern="[a-záéíóúñ A-ZÁÉÍÓÚÑ ]+" class="form-control input-sm" placeholder="Descripcion">
							</div>
							<center>
