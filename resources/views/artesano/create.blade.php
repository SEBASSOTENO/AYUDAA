...
<div class="col-md-8 col-md-offset-2">
	...
	<div class="panel panel-default">
		<div class="panel-heading">
			<h3 class="panel-title">Nuevo Artesanos</h3>
		</div>
		<div class="panel-body">					
			<div class="table-container">
				<form method="POST" action="{{ route('artesano.store') }}"  role="form">
					{{ csrf_field() }}
					<div class="row">
						<div class="col-xs-6 col-sm-6 col-md-6">
							<div class="form-group">
								<p id="error1"></p>
								<input type="text" name="nombre_a" id="nombre_a" onblur="valinom()" pattern="[a-záéíóúñ A-ZÁÉÍÓÚÑ ]+" class="form-control input-sm" placeholder="Nombre del artesano">
							</div>
						</div>
						<div class="col-xs-6 col-sm-6 col-md-6">
							<div class="form-group">
								<p id="error2"></p>
								<input type="text" name="ap_a" id="ap_a" onblur="valiapp()" pattern="[a-záéíóúñ A-ZÁÉÍÓÚÑ ]+" class="form-control input-sm" placeholder="Apellido Paterno del artesano">
							</div>
						</div>
					</div>
					<div class="form-group">	
					<p id="error3"></p>
                    <input type="text" name="am_a" id="am_a" onblur="valiapm()" pattern="[a-záéíóúñ A-ZÁÉÍÓÚÑ ]+" class="form-control input-sm" placeholder="Apellido Materno del artesano">
					</div>
					<div class="row">
						<div class="col-xs-6 col-sm-6 col-md-6">
							<div class="form-group">
							<p id="error4"></p>
								<input type="text" name="edad" id="edad" onblur="valied()" pattern="[0-9]+" class="form-control input-sm"  placeholder="Edad del artesano">
							</div>
						</div>
						<div class="col-xs-6 col-sm-6 col-md-6">
							<div class="form-group">
							<p id="error5"></p>
								<input type="text" name="telefono" id="telefono" onblur="valitel()" pattern="[0-9]+" class="form-control input-sm" placeholder="Telefono del artesano">
							</div>
						</div>
					</div>
					<div class="form-group">
					<p id="error6"></p>
                    <input type="text" name="email" id="email" class="form-control input-sm" onblur="valiema()" pattern="[a-zA-Z0-9\/-_-.*@ñÑ]+" placeholder="Email del artesano">
					</div>
					<div class="row">
