		...
		<div class="col-md-8 col-md-offset-2">
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3 class="panel-title">Nuevo Taller</h3>
				</div>
							...
							<div class="row">
								<div class="col-xs-6 col-sm-6 col-md-6">
									<div class="form-group">
										<p id="error1"></p>
										<input type="text" name="nombre_t" id="nombre_t" onblur="valiun()" pattern="[a-záéíóúñ A-ZÁÉÍÓÚÑ ]+" class="form-control input-sm" placeholder="Nombre Del Taller">
									</div>
								</div>
