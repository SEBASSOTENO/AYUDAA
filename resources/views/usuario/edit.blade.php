		...
		<div class="col-md-8 col-md-offset-2">
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3 class="panel-title">Actualizar Datos de Usuario</h3>
				</div>
				<div class="panel-body">					
					...
					<form method="POST" action="{{ route('usuario.update',$usuario->id) }}"  role="form">
							...
							<div class="row">
								<div class="col-xs-6 col-sm-6 col-md-6">
									<div class="form-group">
										<p id="error1"></p>
										<input type="text" name="nombre_u" id="nombre_u" onblur="valiun()" pattern="[a-záéíóúñ A-ZÁÉÍÓÚÑ ]+" class="form-control input-sm" placeholder="Nombre" value="{{$usuario->nombre_u}}">
									</div>
								</div>
								<div class="col-xs-6 col-sm-6 col-md-6">
									<div class="form-group">
									<p id="error2"></p>
										<input type="text" name="ap_u" id="ap_u" onblur="valiup()" pattern="[a-záéíóúñ A-ZÁÉÍÓÚÑ ]+" class="form-control input-sm" placeholder="Apellido Paterno" value="{{$usuario->ap_u}}">
									</div>
								</div>
							</div>
							...
							<div class="form-group">
							<p id="error3"></p>
                            <input type="text" name="am_u" id="am_u" onblur="valium()" pattern="[a-záéíóúñ A-ZÁÉÍÓÚÑ ]+" class="form-control input-sm" placeholder="Apellido Materno" value="{{$usuario->am_u}}">
							</div>
							<div class="row">
								<div class="col-xs-6 col-sm-6 col-md-6">
									<div class="form-group">
									<p id="error4"></p>
										<input type="text" name="telefono" onblur="valit()" id="telefono" class="form-control input-sm" placeholder="Telefono" value="{{$usuario->telefono}}">
									</div>
								</div>
								<div class="col-xs-6 col-sm-6 col-md-6">
									<div class="form-group">
									<p id="error5"></p>
										<input type="text" name="direccion" id="direccion" onblur="validu()" pattern="[a-záéíóúñ#0-9 A-ZÁÉÍÓÚÑ ,]+" class="form-control input-sm" placeholder="Direccion" value="{{$usuario->direccion}}">
									</div>
								</div>
							</div>
							<div class="form-group">
							<p id="error6"></p>
                            <input type="text" name="email" id="email" class="form-control input-sm" onblur="valiema()" pattern="[a-zA-Z0-9\/-_-.*@ñÑ]+" placeholder="Email" value="{{$usuario->email}}">
							</div>
							<div class="row">
