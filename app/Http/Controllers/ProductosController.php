...
class ProductosController extends Controller
{
    ...
    {
        $this->validate($request,[ 'nombre_p'=>'required', 'costo'=>'required', 'descripcion'=>'required', 'imagen'=>'required']);
    ...
    {
        $this->validate($request,[ 'nombre_p'=>'required', 'costo'=>'required', 'descripcion'=>'required']);
